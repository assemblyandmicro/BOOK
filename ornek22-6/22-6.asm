...
; -----------------------------------------------------------------------
; 8254’un her çevriminde tetiklenen kesmeye ilişkin ISR
; -----------------------------------------------------------------------
NEWINT		PROC FAR
...
NEWINT		ENDP
; -----------------------------------------------------------------------
; ADC dönüşümünün bitmesiyle tetiklenen kesmeye ilişkin ISR
; -----------------------------------------------------------------------
NEWINT2		PROC FAR
...
START 		PROC FAR
; -----------------------------------------------------------------------
; Kesme vektör tablosunu 0A0H tipine NEWINT adreslerinin yerleştirilmesi
; -----------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AL, 0A0H
...
; -----------------------------------------------------------------------
; Kesme vektör tablosunu 0A1H tipine NEWINT2 adreslerinin yerleştirilmesi
; -----------------------------------------------------------------------
			MOV AL, 0A1H
			MOV AH, 4
			MUL AH
			...
			MOV WORD PTR ES:[BX+2], AX 
; -----------------------------------------------------------------------
; 8254’ün koşullandırılamsı
; -----------------------------------------------------------------------
			MOV AL, 34H				; 34H=0011 0100B, CNTR0, 16bit, mod2, binary
			OUT 7EH, AL
			MOV AX, 5
			OUT 78H, AL
			MOV AL, AH
