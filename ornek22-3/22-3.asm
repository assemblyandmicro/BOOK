...
; -----------------------------------------------------------------------
; 8255 GrupA mod1 giriş için kesme alt programı
; -----------------------------------------------------------------------
NEWINT		PROC FAR
...
;------------------------------------------------------------------------
			...
			MOV DS, AX
;------------------------------------------------------------------------
; Vektör tablosu TİP30’a NEWINT ISR adresleri yerleştirilir
;------------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AL, 30H
...
;------------------------------------------------------------------------
			MOV AL, 09H
			OUT 7EH, AL				; GrupA mod1 giriş
			MOV AL, 0B8H			; BSR modda INTRA aktif
			OUT 7EH, AL 
;------------------------------------------------------------------------
; 8259 ayarları
;------------------------------------------------------------------------
