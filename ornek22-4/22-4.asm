...
;------------------------------------------------------------------------
			...
			MOV DS, AX
;------------------------------------------------------------------------
; Kesme vektör tab. TİP 78H’a NEWINT ISR adreslerinin yerleştirilmesi
;------------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AL, 78H
...
;------------------------------------------------------------------------
; Kesme vektör tab. TİP 79H’a NEWINT2 ISR adreslerinin yerleştirilmesi
;------------------------------------------------------------------------
			MOV AL, 79H
			MOV AH, 4
			MUL AH
...
;------------------------------------------------------------------------
			MOV AL, 13H
			OUT 60H, AL
			MOV AL, 78H				; IR0 78H tipnde kesme sağlar
			OUT 62H, AL
			MOV AL, 03H
			OUT 62H, AL
