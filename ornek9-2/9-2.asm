...
; toplayarak elde edilen sonucu TOPLAM isimli 64 bitlik değişkene
...
;------------------------------------------------------------------------
        LEA SI, ASAYISI  ; Sayılarla bir seferde 64 bit toplama yapılmadığı
        LEA DI, BSAYISI  ; için 16 bitlik parçalar halinde okunacaktır
