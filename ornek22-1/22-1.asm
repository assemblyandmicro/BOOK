...
; kesme alt programını vektör tablosuna yerleştiren 
...
;------------------------------------------------------------------------
			...
			MOV OLDSG, AX
;------------------------------------------------------------------------
; Vektör tablosu TİP0 değeri NEWINT’i gösterecek şekilde değiştirilir
;------------------------------------------------------------------------
			LEA AX, NEWINT	; DIV0 için yeni ISR ofseti
			MOV WORD PTR ES:[0], AX
			MOV AX, CS	; DIV0 için yeni ISR segmenti
...
TEKRAR:		XOR DX, DX
			...
			LOOP TEKRAR
;------------------------------------------------------------------------
; Program sonlandırılmadan önce orijinal DIV0 ISR adresleri geri yazılır
;------------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AX, OLDOF
