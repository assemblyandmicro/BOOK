...
; 8259, ADC0804, komparator yardımıyla analog gerilim değerlerinden 
; faydalanarak kesme tabalı tuş tarama assembly program 
; -----------------------------------------------------------------------
			PAGE 60, 80
			TITLE 8259, ADC0804, karşılaştıcı ile kesme tabanlı tuş tarama
...
; -----------------------------------------------------------------------
; ADC dönüşümü bitince çağrılacak olan ISR
; -----------------------------------------------------------------------
NEWINT		PROC FAR
			PUSH BP
			MOV BP, SP
...
NEWINT		ENDP
; -----------------------------------------------------------------------
; Herhangi bir tuşa basıldığında tetiklenecek ISR
; -----------------------------------------------------------------------
NEWINT2 	PROC FAR
			PUSH BP
			MOV BP, SP
...
;------------------------------------------------------------------------
			...
			MOV DS, AX
;------------------------------------------------------------------------
; Kesme vektör tab. TİP 40H’a NEWINT ISR adreslerinin yerleştirilmesi
;------------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AL, 40H
...
;------------------------------------------------------------------------
; Kesme vektör tab. TİP 47H’a NEWINT2 ISR adreslerinin yerleştirilmesi
;------------------------------------------------------------------------
			XOR AX, AX
			MOV ES, AX
			MOV AL, 47H
