...
START 		PROC FAR				; ana yordam
			MOV DX, 020Ah
			MOV AL, 01001101B
			OUT DX, AL				; mod yazmacına erişim
			MOV AL, 40H
			OUT DX, AL				; kontrol yazmacı ile 8251 resetleme
			MOV AL, 01001101B		; mod:1 stop biti, parity kullanmadan,
									; 8 bit veri, 1 çarpan
			OUT DX, AL
			MOV AL, 00010001B		; kontrol: veri gönderme aktif, 
									; hata bitlerini temizle
			OUT DX, AL
ENDLESS:	MOV DX, 020AH			; durum yazmacı adresi
