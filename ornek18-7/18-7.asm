...
ENDLESS:	MOV DX,00H
			...
			MOV BL, 08H				; BL’nin 3. biti 1, diğer bitleri 0
SUTUN:		SHR BL, 1				; ilk geçişte BL’nin 2. biti, ikinci geçişte 
									; 1. biti,üçüncü geçişte 0. biti 1, 
									; diğer bitleri 0
			MOV AL, BL
			OUT 0ABH, AL			; ilk geçişte 1 nolu sütun, ikinci geçişte 
									; 2 nolu sütun, üçüncü geçişte 3 nolu sütun 
									; aktif edilir
			IN AL, 0ADH				; satırları oku
			AND AL, 0FH				; PortCL bitlerini koru, 
									; PortCH bitlerini maske ile 0’la
...
DEVAM2:		ADD AX, DX				; AX <- basılan tuş indisi 
			MOV SI, AX
			MOV AL, DIGITS[SI]
									; AL<-basılan tuşa karşılık 7 parçalı gösterge veri-si
