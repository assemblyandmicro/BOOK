; -----------------------------------------------------------------------
; 10 adet word tipinde elemanı olan bir dizi elemanlarının binary (ikili
; sayı sisteminde) gösteriminde en çok 1 barındıran elemanın adresini
; bulan ve bunu bellek üzerindeki bir değişkende saklayan COM program 
; -----------------------------------------------------------------------
...
L2:			MOV AX, DIZI[SI]
			...
			MOV CX, 16			; dizi word olduğu için öteleme işlemi 16 defa tekrarlı 
